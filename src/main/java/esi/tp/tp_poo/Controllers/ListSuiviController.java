...
public class ListSuiviController implements Initializable {
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        AjouterBilan.setOnAction(this::handleAjouterFiche);
        ...
        tableView.setRowFactory(tv -> {
            ...
            row.setOnMouseClicked(event -> {
                if (event.getClickCount() == 2 /*&& (!row.isEmpty())*/) {
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/Suivi.fxml"));
                    Scene scene = null;
                    try {
...
public void closeConnection() {
    ...
    @FXML
    private void handleAjouterFiche(ActionEvent event) {
